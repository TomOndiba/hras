...
class Memorandum1 extends CI_Controller {
    ...
    public function add($id = NULL) {
        ...
        $this->form_validation->set_rules('memorandum_absent_date', 'Mangkir', 'trim|required|xss_clean');
        $this->form_validation->set_rules('memorandum_date_sent', 'Kirim', 'trim|required|xss_clean');
        $this->form_validation->set_rules('memorandum_call_date', 'Datang', 'trim|required|xss_clean'); 
        ...
        if ($_POST AND $this->form_validation->run() == TRUE) {
            ...
            $this->Activity_log_model->add(
                    array(
                        ...
                        'log_module' => 'Surat Panggilan',
                        'log_action' => $data['operation'],
                        'log_info' => 'ID:'.$status.';Title:' . $params['employe_id']
                    )
            );
            ...
            $data['title'] = $data['operation'] . ' Surat Panggilan';
