...
<div class="col-md-12 col-sm-12 col-xs-12 main post-inherit">
    ...
    Daftar Surat Panggilan 3 
        <span class="pull-right add-btn hidden-xs">
            ...
            <a href="<?php echo site_url('admin/memorandum3/add'); ?>" role="button"><span class="fa fa-plus"> Tambah</span></a>
        </span>
        <span class="pull-right add-btn hidden-lg hidden-md hidden-sm">
            ...
            <a href="<?php echo site_url('admin/memorandum3/add'); ?>" role="button"><span class="fa fa-plus"></span></a>
        </span>
    </div>
