    ...
    <div class="x_panel post-inherit">
        ...
        <div class="row">
            <div class="col-sm-9 col-md-9">
                ...
                <input name="par_number" placeholder="No. PAR" type="text" class="form-control" value="<?php echo $inputNumber; ?>"><br>  
                ...
                <label >Nominal *</label>
                <input name="par_paid" placeholder="Nominal PAR" type="text" class="form-control" value="<?php echo $inputPaid; ?>"><br>                
