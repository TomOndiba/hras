...
class Memorandum1_model extends CI_Model {
    ...
    function get($params = array()) {
        ...
        $this->db->select('memorandum1.memorandum_id, memorandum1.memorandum_number, memorandum_email_date, memorandum_finished_desc,
            memorandum_absent_date, memorandum1.memorandum_date_sent, memorandum1.memorandum_call_date, memorandum1.memorandum_is_present, employe_employe_nik, memorandum1.user_user_id,
